...
const universities = [];
graduates.forEach(people => universities.push(people.university));
universities.sort();
...
const contactInfo = [];
graduates.forEach(people => contactInfo.push(people.first_name + ' ' + people.email));
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = [];
graduates.forEach(function(people){
  if(people.university.includes('Uni')){
    unisWithUni.push(people.university)
  }})
